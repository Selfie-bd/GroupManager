...
You know how hard it is sometimes to manage group so here is the solution for you ⚜️
...
Made from the source code of [selfiebd 🇮🇳](t.me/selfiebd)

Click /help or Help button below to find out more about how to use me to my full potential.

 Add me to a group by clicking [here](http://t.me/CF_GroupManager_bot?startgroup=true).
"""
